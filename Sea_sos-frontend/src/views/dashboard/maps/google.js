...
import 'lazysizes';
import { gabesZerzisCoordinates, monastirGabesCoordinates, tabarkacapbonCoordinates, tunisMonastirCoordinates } from "./coords";
...
const LocationMarkers = ({ refresh, markers, setMarkers }) => {
    ...
    const refreshData = async (latlng) => {
        try {
            const response = await axios.get(`/api/urgences/find-urgence/${latlng.lng}/${latlng.lat}`, {
                headers: {
